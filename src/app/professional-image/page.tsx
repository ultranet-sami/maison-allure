...
export const metadata: Metadata = {
  ...
  description: "Construisez une image professionnelle puissante avec Maison Allure. Presence executive, coaching image leadership, preparation entretiens et personal branding.",
};
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="font-montserrat text-sm text-black/70 leading-relaxed mb-8">
              ...
              des portes. Maison Allure vous aide a en faire un vrai atout strategique.
            </p>
