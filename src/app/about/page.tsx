...
export const metadata: Metadata = {
  title: "A Propos",
  description: "Decouvrez l'histoire, la mission et la philosophie de Maison Allure, maison de conseil en image inspiree de l'elegance francaise.",
};
      ...
      <section className="pt-40 pb-24 bg-ivory">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <p className="font-montserrat text-sm text-black/60 max-w-2xl leading-relaxed">
            Maison Allure est bien plus qu&apos;une maison de conseil en image. C&apos;est un espace de transformation
        ...
        <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div>
            ...
            <p className="font-montserrat text-sm text-black/70 leading-relaxed mb-6">
              Maison Allure est nee d&apos;une conviction profonde : l&apos;image que nous projetons au monde
            ...
            <p className="font-montserrat text-sm text-black/70 leading-relaxed">
              Aujourd&apos;hui, Maison Allure accompagne une clientele exigeante en France et a
          ...
          <div className="bg-ivory p-12 border-l-4 border-gold">
            ...
            <div className="font-montserrat text-[10px] tracking-[0.3em] uppercase text-gold">
              — La Fondatrice de Maison Allure
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="font-montserrat text-sm text-black/70 leading-relaxed mt-8 mb-6">
              La philosophie de Maison Allure s&apos;inspire de cette tradition francaise unique : l&apos;art
      ...
      <section className="py-24 bg-gold">
        <div className="max-w-3xl mx-auto px-6 text-center">
          ...
          <p className="font-montserrat text-sm text-black/70 mb-10">
            Rencontrons-nous pour une consultation initiale et decouvrez comment Maison Allure peut
